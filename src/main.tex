...
\input{Intro}
\input{Linear and k-nn models}
\input{Neural Networks}
\input{Validation}
\input{Support Vector Machines}
\input{Bias, Variance, and Ensembling}
\input{Deep Learning}
\input{Randomized Machine Learning}
\input{Self-Organizing Maps}
\input{Recurrent Neural Networks}
\input{Structured Domains Learning}
